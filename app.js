...
tempsAffichage.innerText = `Temps : ${temps} sec`;
...
function time() {
  ...
  if (temps === 0) {
    clearInterval(timer);
    phraseAEcrire.innerHTML = "Jeu terminé ! <br> Cliquez ici pour recommencer !";
    phraseTest.style.display = "none";
    phraseAEcrire.addEventListener("click", () => {
